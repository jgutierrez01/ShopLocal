...
{
    [Serializable]
    public class DetMaterialSpool
    {
        public DetMaterialSpool() { }

        public DetMaterialSpool(MaterialSpool material)
        {
            MaterialSpoolID = material.MaterialSpoolID;
            ItemCodeID = material.ItemCodeID;
            CodigoItemCode = material.ItemCode.Codigo;
            DescripcionItemCode = material.ItemCode.DescripcionEspanol;
