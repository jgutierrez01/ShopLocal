...
{
    [Serializable]
    public class DetCorteSpoolHistorico
    {
        public DetCorteSpoolHistorico() { }

        public DetCorteSpoolHistorico(CorteSpoolHistorico corte, Dictionary<int, string> tiposCorte)
        {
            CorteSpoolID = corte.CorteSpoolID;
            Diametro = corte.Diametro;
            //ItemCodeID = corte.ItemCode.ItemCodeID;
            CodigoItemCode = corte.ItemCodeCodigo;
            DescripcionItemCode = corte.ItemCodeDescripcionEspanol;
