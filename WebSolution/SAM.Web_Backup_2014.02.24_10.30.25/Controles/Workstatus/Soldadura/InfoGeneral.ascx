    ...
    <div class="divIzquierdo ancho70">
        ...
        <div class="divDerecho ancho50 boldElements">
            ...
            <div class="separador">
                ...
                <mimo:MappableDatePicker runat="server" AutoPostBack="true" OnSelectedDateChanged="mdpFechaReporte_OnSelectedDateChanged" ID="mdpFechaReporte" Style="width: 209px" />
                <span class="required">*</span>
