<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoSpoolRO.ascx.cs" Inherits="SAM.Web.Controles.Spool.InfoSpoolRO" EnableViewState="false" %>
<div class="infoSpool soloLectura">
    <div class="clear">
        <div class="divIzquierdo ancho30">
            ...
            <div class="separador">
                <mimo:LabeledTextBox meta:resourcekey="txtDiametroMayor" ID="txtDiametroMayor" EntityPropertyName="DiametroMayor" runat="server" ReadOnly="true" />
            </div>
        </div>
        <div class="divIzquierdo ancho30">
            <div class="separador">
