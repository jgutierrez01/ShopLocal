    ...
    public partial class SeguimientoSpool : SamPaginaPrincipal
    {
        ...
        protected void repHeaderSegmento_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            else if (e.Item.IsItem())
            {
                ...
                literal.Text = @"<td class=""" + campoSeguimientoSpool.CssColumnaUI + @""" width=""" +
                               campoSeguimientoSpool.AnchoUI + @""" >" +
                              nombreColumna + @"</td>";
            }
        }
        ...
        {   
            ...
            else if (e.Item.IsItem())
            {
                ...
                literal.Text = @"<td class=""" + campoSeguimientoSpool.CssColumnaUI + @""" width=""" +
                               campoSeguimientoSpool.AnchoUI + @""" >" + campoSeguimientoSpool.Nombre + @"</td>";
            }
