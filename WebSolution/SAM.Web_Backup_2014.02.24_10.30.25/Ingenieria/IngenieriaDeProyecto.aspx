                ...
                <CommandItemTemplate>
                    <div class="comandosEncabezado">
                        ...
                        <samweb:AuthenticatedHyperLink runat="server" meta:resourcekey="imgActualizaSpool" ID="imgActualizaSpool"
                            ImageUrl="~/Imagenes/Iconos/agregar.png" CssClass="imgEncabezado"  />
                        <asp:HyperLink meta:resourcekey="lnkDocumentoAprobado" runat="server" ID="lnkDocumentoAprobado" CssClass="link" />
                        <asp:HyperLink meta:resourcekey="imgDocumentoAprobado" runat="server" ID="imgDocumentoAprobado" ImageUrl="~/Imagenes/Iconos/icono_certificar.png" CssClass="imgEncabezado" />
                        ...
                        <asp:LinkButton runat="server" ID="lnkActualizarDatos" CommandName="ActualizarDatos" CssClass="link" OnClientClick="return Sam.Confirma(22);" meta:resourcekey="lnkActualizarDatos"  />
                ...
                <Columns>
                   ...
                   <%-- <telerik:GridTemplateColumn AllowFiltering="false" Reorderable="false" Resizable="false"
                    ...
                    <telerik:GridTemplateColumn UniqueName="hypDetalle" meta:resourcekey="gbcSpool" AllowFiltering="true" 
                        Reorderable="false" Resizable="false" HeaderStyle-Width="150" FilterControlWidth="100" DataField="Nombre">
                        <ItemTemplate>
