            ...
            <div class="divIzquierdo ancho50">
                ...
                <div class="separador">
                    <asp:Label ID="lblFechaInspeccion" runat="server" meta:resourcekey="lblFechaInspeccion"
                        CssClass="bold" />
                    <br />
                    <telerik:RadDatePicker ID="rdpFechaInspeccion" runat="server" MinDate="01/01/1960"
                        MaxDate="01/01/2050" EnableEmbeddedSkins="false" />
                    <span class="required">*</span>
                    <asp:RequiredFieldValidator ID="valFechaInspeccion" runat="server" ControlToValidate="rdpFechaInspeccion"
