...
<telerik:RadWindow runat="server" ID="rdwCambiarFechaArmado">
    <ContentTemplate>
      ...
      <div style="width: 750px;">
        ...
        <asp:CustomValidator runat="server" ID="cvFechas" ErrorMessage="" ControlToValidate="hfFechaArmado" ClientValidationFunction="Sam.Workstatus.CVFechaReporteSoldadura" EnableClientScript="true" Display="None" ValidationGroup="valGuardar">
        </asp:CustomValidator>
        ...
        <div class="pestanaBoton" id="divGuardar" runat="server">
             <asp:Button runat="server" ID="btnGuardar" meta:resourcekey="btnGuardar" CssClass="boton" OnClick="btnGuardarPopUp_OnClick" ValidationGroup="valGuardar" />
        </div>
