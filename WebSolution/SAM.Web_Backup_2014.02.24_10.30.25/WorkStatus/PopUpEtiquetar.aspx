...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
   ...
   <div class="divIzquierdo ancho50">
        ...
        <div class="separador">
            <asp:Label runat="server" ID="lblFechaEtiqueta" meta:resourcekey="lblFechaEtiqueta" CssClass="bold" />
            <br />
            <mimo:MappableDatePicker ID="mdpFechaEtiqueta" runat="server" Style="width: 209px" />
            <span class="required">*</span>
            <asp:RequiredFieldValidator ID="valFecha" runat="server" ControlToValidate="mdpFechaEtiqueta"
