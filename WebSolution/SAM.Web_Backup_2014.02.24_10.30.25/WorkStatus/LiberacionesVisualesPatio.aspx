<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true" CodeBehind="LiberacionesVisualesPatio.aspx.cs" Inherits="SAM.Web.WorkStatus.LiberacionesVisualesPatio" %>
 ...
 <telerik:RadAjaxManager runat="server" style="display:none;"  ID="rdManager">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnRefresh">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdLiberacionVisualPatio" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
       ...
       <asp:ValidationSummary ID="valSummary" runat="server" DisplayMode="BulletList" CssClass="summaryList" meta:resourcekey="valSummary" />
        <p></p>
         ...
         <asp:PlaceHolder runat="server" ID="phGrid" Visible="false">
             <mimo:MimossRadGrid ID="grdLiberacionVisualPatio" 
                                 runat="server" 
                                 OnNeedDataSource="grdLiberacionVisualPatio_OnNeedDataSource"
                                 OnItemCreated="grdLiberacionVisualPatio_ItemCreated"
                                 OnItemDataBound="grdLiberacionVisualPatio_OnItemDataBound"
                ...
                <MasterTableView AutoGenerateColumns="false"
                                 AllowMultiColumnSorting="true"
                                 DataKeyNames="InspeccionVisualPatioID"
                                 ClientDataKeyNames="InspeccionVisualPatioID">   
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="HdEtiquetaJunta" DataField="EtiquetaJunta" HeaderText="Etiqueta Junta"
                            HeaderStyle-Width="180" FilterControlWidth="100" Groupable="false"  meta:resourcekey="HdEtiquetaJunta"/>    
                        <telerik:GridBoundColumn UniqueName="HdTipoJunta" DataField="TipoJunta" HeaderText="Tipo Junta"
                            HeaderStyle-Width="180" FilterControlWidth="100" Groupable="false"  meta:resourcekey="HdTipoJunta"/>
