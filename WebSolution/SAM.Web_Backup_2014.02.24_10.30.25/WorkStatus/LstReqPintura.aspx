...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="contenedorCentral">
        ...
        <asp:PlaceHolder runat="server" ID="phReqNumerosUnicos" Visible="false">
            ...
            <mimo:MimossRadGrid runat="server" ID="grdReqNum" OnNeedDataSource="grdReqNum_OnNeedDataSource"
                 OnItemCreated="grdReqNum_OnItemCreated" AllowMultiRowSelection="true">
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" ClientDataKeyNames="WorkstatusSpoolID,SpoolID"
                    DataKeyNames="WorkstatusSpoolID,SpoolID">
                    <CommandItemTemplate>
                        <div class="comandosEncabezado">
                            <asp:HyperLink meta:resourcekey="lnkEspecificar" runat="server" ID="lnkEspecificar"
                                CssClass="link" NavigateUrl="" />
                            <asp:ImageButton runat="server" ID="imgEspecificar" ImageUrl="~/Imagenes/Iconos/icono_especificarsistema.png"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn meta:resourcekey="spool" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="NombreSpool" />
                        <telerik:GridBoundColumn meta:resourcekey="numControl" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="NumeroControl" />
                        <telerik:GridBoundColumn meta:resourcekey="sistema" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="Sistema" />
                        <telerik:GridBoundColumn meta:resourcekey="color" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="Color" />
                        <telerik:GridBoundColumn meta:resourcekey="codigo" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="Codigo" />
                        <telerik:GridCheckBoxColumn meta:resourcekey="hold" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="Hold" />
                        <telerik:GridBoundColumn meta:resourcekey="especificacion" HeaderStyle-Width="150" FilterControlWidth="100"
                            DataField="EspecificacionSpool" />
