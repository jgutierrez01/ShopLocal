<%@ Page Language="C#" MasterPageFile="~/Masters/Proyectos.master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="SAM.Web.Proyectos.Proveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <sam:BarraTituloPagina runat="server" ID="titulo" meta:resourcekey="lblProveedoresProyecto" />
    <div class="cntCentralForma">
        <div class="dashboardCentral">
            <div class="listaCheck clear ancho90" style="padding-top:15px;">
                <asp:CheckBoxList runat="server" ID="chkProveedores" CssClass="cajaAzul" RepeatColumns="3" Width="100%" />
            </div>
        </div>
    </div>
