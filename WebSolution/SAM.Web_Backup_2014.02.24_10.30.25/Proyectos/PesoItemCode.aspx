<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Proyectos.master"
    CodeBehind="PesoItemCode.aspx.cs" Inherits="SAM.Web.Proyectos.PesoItemCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <sam:BarraTituloPagina runat="server" ID="titulo" meta:resourcekey="lblPesoItemCodes" />
    <asp:CustomValidator
        runat="server"
