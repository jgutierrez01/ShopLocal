...
{
    public partial class ReporteOdt : SamPaginaPrincipal
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                byte[] reporte = UtileriasReportes.ObtenReporteOdt(EntityID.Value, true, true, true, true, true, true, true, true, true, true, true, true, true,true, true);
