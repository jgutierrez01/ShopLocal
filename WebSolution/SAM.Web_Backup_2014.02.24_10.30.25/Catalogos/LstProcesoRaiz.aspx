<%@ Page  Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true"
    CodeBehind="LstProcesoRaiz.aspx.cs" Inherits="SAM.Web.Catalogos.LstProcesoRaiz" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
     <telerik:RadAjaxManager runat="server" style="display:none;"  ID="ajaxMgr">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="grdProcesoRaiz">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdProcesoRaiz" LoadingPanelID="lpGrid"/>
    ...
    <div class="contenedorCentral">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdProcesoRaiz" OnNeedDataSource="grdProcesoRaiz_OnNeedDataSource"
            OnItemCommand="grdProcesoRaiz_ItemCommand" OnItemDataBound="grdProcesoRaiz_ItemDataBound">
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true">
                <CommandItemTemplate>
                    <div class="comandosEncabezado">
                        <div class="tituloGrid">
                            <asp:Label meta:resourcekey="lblLstProRaiz" runat="server" ID="lblLstProRaiz" />
                        </div>
                        <samweb:AuthenticatedHyperLink runat="server" ID="lnkAgregar" NavigateUrl="~/Catalogos/DetProcesoRaiz.aspx"
                        ...
                        <samweb:AuthenticatedHyperLink runat="server" ID="imgAgregar" ImageUrl="~/Imagenes/Iconos/agregar.png"
                            CssClass="imgEncabezado" NavigateUrl="~/Catalogos/DetProcesoRaiz.aspx" meta:resourcekey="imgAgregar"/>
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                        Groupable="false">
                        <ItemTemplate>
                            <asp:LinkButton CommandName="Borrar" ID="lnkBorrar" runat="server" CommandArgument='<%#Eval("ProcesoRaizID") %>'
                    ...
                    <telerik:GridBoundColumn UniqueName="ProcesoRaizID" DataField="ProcesoRaizID" Visible="false" />
