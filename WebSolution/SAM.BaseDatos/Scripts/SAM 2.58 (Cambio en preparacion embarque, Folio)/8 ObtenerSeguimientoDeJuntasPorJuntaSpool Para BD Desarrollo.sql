...
/****************************************************************************************
	...
	Modificado:	08/16/2011 IHM
				...
				04/07/2014 JHT -- cambio Fecha Preparacion a Folio Preparacion Embarque
*****************************************************************************************/
...
BEGIN
	...
	(	
		...
		PruebaHidrostaticaPresion VARCHAR(150)
	)
	...
	INSERT INTO #TempSpool
		SELECT s.SpoolID,
               ...
               Campo4,
               Campo5,
			   (CASE WHEN odt.NumeroOrden LIKE 'R%' THEN 1 ELSE 0 END),
			   (CASE WHEN odt.NumeroOrden LIKE 'R%' THEN odt.NumeroOrden ELSE '' END),
			   (CASE WHEN odts.NumeroControl LIKE 'R%' THEN odts.NumeroControl ELSE '' END)
		FROM Spool s
		LEFT OUTER JOIN Cuadrante c
		on s.CuadranteID = c.CuadranteID
		LEFT OUTER JOIN OrdenTrabajoSpool odts
		ON s.SpoolID = odts.SpoolID
		LEfT OUTER JOIN OrdenTrabajo odt
		ON odts.OrdenTrabajoID = odt.OrdenTrabajoID
		WHERE s.SpoolID IN
		(
...
INSERT INTO #TempJuntaSpool
	...
	select g.GeneralJuntaWorkstatusID,
		   ...
		   tmph.PruebaHidrostaticaPresion as PruebaHidroPresion
	from #TempGeneral g 
