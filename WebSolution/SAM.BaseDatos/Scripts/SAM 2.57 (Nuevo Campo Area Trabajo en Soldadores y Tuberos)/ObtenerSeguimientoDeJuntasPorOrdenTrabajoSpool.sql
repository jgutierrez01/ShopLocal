...
BEGIN
		...
		(        
			...
			NumeroControlEspecial NVARCHAR(50)
		)
	...
	WHERE NOT EXISTS
		...
		INSERT INTO #TempSpool
			   ...
			   odtes.NumeroControl
				...
				LEFT OUTER JOIN OrdenTrabajoEspecialSpool odtes
				ON s.UltimaOrdenTrabajoEspecial = odtes.NumeroControl
				LEFT OUTER JOIN OrdenTrabajoEspecial odte
				ON odtes.OrdenTrabajoEspecialID = odte.OrdenTrabajoEspecialID
				WHERE s.SpoolID IN
				(
...
-------------------------------------------------------------------------------------------------------------------------------
		...
		select g.GeneralJuntaWorkstatusID,
				   ...
				   ja.AreaTrabajo [AreaTrabajoTubero],-----------------------------------------------------------------------------------------
