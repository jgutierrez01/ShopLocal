...
/****************************************************************************************
	...
	Modificado:	JHT 23/01/2014 -- Agregar campo DiametroMayor
				...
				AHS 09/07/2014 -- Inspector en inspeccion dimensional
*****************************************************************************************/
	...
	(
		...
		(
			SELECT	tjs.SpoolID,
					...
					SUM(
						CASE	WHEN (tjss.TipoJuntaID = @TW and tjwss.JuntaArmadoID is not null and tjwss.ArmadoAprobado = 1) or (tjwss.JuntaSoldaduraID is not null and tjwss.SoldaduraAprobada = 1) THEN 1
								ELSE 0 END
					) [Soldadas],
					SUM(
			...
			FROM JuntaSpool tjs
			INNER JOIN JuntaSpool tjss on tjs.JuntaSpoolID = tjss.JuntaSpoolID
			LEFT JOIN JuntaWorkstatus tjws on tjs.JuntaSpoolID = tjws.JuntaSpoolID and tjws.VersionJunta = 1
			LEFT JOIN JuntaWorkstatus tjwss on tjss.JuntaSpoolID = tjwss.JuntaSpoolID and tjwss.VersionJunta = 1
