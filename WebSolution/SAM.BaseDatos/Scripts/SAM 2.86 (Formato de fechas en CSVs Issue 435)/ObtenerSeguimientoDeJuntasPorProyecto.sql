/****** Object:  StoredProcedure [dbo].[ObtenerSeguimientoDeJuntasPorProyecto]    Script Date: 1/24/2014 6:04:58 PM ******/
...
/****************************************************************************************
	...
	Autor:		MMG
				...
				JHT, 24/01/2014
				JHT, 07/02/2014
				GTG, 01/03/2014 Fecha Emision
				GTG, 10/03/2014 Vigencia Aduana
                                Bernardo Garza, 13/05/2014 -- cambios en cálculo de % armado y soldadura
				GTG 05/06/2014 se agrego el campo RequierePwht en JuntaSpool
				...
				05/08/2014 JHT -- Cambios a las tablas y campos se agrupadores por junta
...
BEGIN
	...
	(
		...
		GeneralUsuarioOkPnd VARCHAR(100),
