/****** Object:  StoredProcedure [dbo].[ObtenerSeguimientoDeJuntasPorOrdenTrabajo]   Script Date: 01/30/2014 15:35:09 ******/
...
/****************************************************************************************
	...
	Modificado:	28/01/2011 IHM
				...
				18/03/2014 GTG FechaEmision
				10/04/2014 GT Vigencia Aduana
                                Bernardo Garza, 13/05/2014 -- cambios en cálculo de % armado y soldadura
				05/06/2014 GTG se agrego el campo RequierePwht
				...
				14/05/2014 JHT -- Campo Presion para pruebas hidrostaticas
				GTG 23/07/2014 -- Nuevos campos en modulo Agrupadores
				04/08/2014 JHT -- Nuevos campos de agrupadores PND, Soportes, Reparaciones
				05/08/2014 JHT -- Cambios a los campos y tablas de agrupadores por juntas
				GTG 23/07/2014 -- Nuevos campos en modulo Agrupadores
...
INSERT INTO #SpoolTramoRecto
	...
	INSERT INTO #TempTratamientoPwht		
		SELECT 
			DISTINCT jrtt.JuntaReporteTtID,
			   jr.JuntaWorkstatusID,
...
INSERT INTO #TempGeneral (
			...
			FROM Spool s
				...
				LEFT JOIN SpoolHoldHistorial ON SpoolHoldHistorial.SpoolHoldHistorialID = tHoldHistorial.SpoolHoldHistorialID
			WHERE (s.SpoolID NOT IN (SELECT SpoolID FROM JuntaSpool)
				OR s.SpoolID IN (SELECT SpoolID from #SpoolTramoRecto))
				AND ots.OrdenTrabajoID = @OrdenTrabajoID
-------------------------------------------------------------------------------------------------------------------------------
