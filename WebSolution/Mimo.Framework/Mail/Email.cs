...
namespace Mimo.Framework.Mail
{
    public class Email
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool SendWithAttachmentFileNameAsync()
        {
            ThreadStart start = new ThreadStart(SendThreadProcWithAttachmentFileName);
        ...
        /// 
        /// </summary>
        private void SendThreadProcWithAttachmentFileName()
        {
            try
            {
                Smtp smtp = new Smtp();

                smtp.SendAttachFile(_smtpPort, _smptHost,_from,_login,_password, _to,
                          _subject, _body,true, _fileName);
            }
            catch (System.Exception ex)
            {
                _logger.Error("Error while sending email with attachment FileName, SendThreadProcWithAttachmentFileName",
                              ex);
            }
        }
        /// <summary>
