...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class ProyectoConfiguracionCorreo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProyecto(Proyecto previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ProyectoConfiguracionCorreo, this))
            {
                previousValue.ProyectoConfiguracionCorreo = null;
            }
    
            if (Proyecto != null)
            {
                Proyecto.ProyectoConfiguracionCorreo = this;
        ...
        private void FixupUsuario(Usuario previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.ProyectoConfiguracionCorreo.Contains(this))
            {
                previousValue.ProyectoConfiguracionCorreo.Remove(this);
            }
    
            if (Usuario != null)
            {
                if (!Usuario.ProyectoConfiguracionCorreo.Contains(this))
                {
                    Usuario.ProyectoConfiguracionCorreo.Add(this);
                }
