...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class Inspector: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int InspectorID
        {
            ...
            set
            {
                if (_inspectorID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'InspectorID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _inspectorID = value;
        ...
        private void FixupPatio(Patio previousValue)
        {
            ...
            if (previousValue != null && previousValue.Inspector.Contains(this))
            {
                previousValue.Inspector.Remove(this);
            }
    
            if (Patio != null)
            {
                if (!Patio.Inspector.Contains(this))
                {
                    Patio.Inspector.Add(this);
                }
        ...
        private void FixupTaller(Taller previousValue)
        {
            ...
            if (Taller != null)
            {
                if (!Taller.Inspector.Contains(this))
                {
                    Taller.Inspector.Add(this);
                }
