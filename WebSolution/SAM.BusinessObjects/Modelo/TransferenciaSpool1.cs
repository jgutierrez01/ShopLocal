...
namespace SAM.Entities
{
    ...
    [KnownType(typeof(Transferencia1))]
    [KnownType(typeof(Usuario))]
    [Serializable]
    public partial class TransferenciaSpool1: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Transferencia1> Transferencia
        {
            get
            {
                if (_transferencia == null)
                {
                    _transferencia = new TrackableCollection<Transferencia1>();
        ...
        private TrackableCollection<Transferencia1> _transferencia;
        ...
        private void FixupSpool(Spool previousValue)
        {
            ...
            if (previousValue != null && previousValue.TransferenciaSpool1.Contains(this))
            {
                previousValue.TransferenciaSpool1.Remove(this);
            }
    
            if (Spool != null)
            {
                if (!Spool.TransferenciaSpool1.Contains(this))
                {
                    Spool.TransferenciaSpool1.Add(this);
                }
        ...
        private void FixupUsuario(Usuario previousValue, bool skipKeys = false)
        {
            ...
            if (Usuario != null)
            {
                if (!Usuario.TransferenciaSpool1.Contains(this))
                {
                    Usuario.TransferenciaSpool1.Add(this);
                }
        ...
        private void FixupTransferencia(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (Transferencia1 item in e.NewItems)
                {
            ...
            if (e.OldItems != null)
            {
                foreach (Transferencia1 item in e.OldItems)
                {
