...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class CostoArmado: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int CostoArmadoID
        {
            get { return _costoArmadoID; }
            set
            {
                if (_costoArmadoID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'CostoArmadoID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _costoArmadoID = value;
                    OnPropertyChanged("CostoArmadoID");
                }
            }
        }
        private int _costoArmadoID;
        ...
        private void FixupCedula(Cedula previousValue)
        {
            ...
            if (previousValue != null && previousValue.CostoArmado.Contains(this))
            {
                previousValue.CostoArmado.Remove(this);
            }
    
            if (Cedula != null)
            {
                if (!Cedula.CostoArmado.Contains(this))
                {
                    Cedula.CostoArmado.Add(this);
                }
        ...
        private void FixupDiametro(Diametro previousValue)
        {
            ...
            if (Diametro != null)
            {
                if (!Diametro.CostoArmado.Contains(this))
                {
                    Diametro.CostoArmado.Add(this);
                }
        ...
        private void FixupFamiliaAcero(FamiliaAcero previousValue)
        {
            ...
            {
                if (!FamiliaAcero.CostoArmado.Contains(this))
                {
                    FamiliaAcero.CostoArmado.Add(this);
                }
        ...
        private void FixupProyecto(Proyecto previousValue)
        {
            ...
            if (Proyecto != null)
            {
                if (!Proyecto.CostoArmado.Contains(this))
                {
                    Proyecto.CostoArmado.Add(this);
                }
        ...
        private void FixupTipoJunta(TipoJunta previousValue)
        {
            ...
            if (TipoJunta != null)
            {
                if (!TipoJunta.CostoArmado.Contains(this))
                {
                    TipoJunta.CostoArmado.Add(this);
                }
