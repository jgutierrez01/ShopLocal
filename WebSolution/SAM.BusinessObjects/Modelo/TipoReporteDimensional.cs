...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class TipoReporteDimensional: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TipoReporteDimensionalID
        {
            ...
            set
            {
                if (_tipoReporteDimensionalID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TipoReporteDimensionalID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupReporteDimensional(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.TipoReporteDimensional = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TipoReporteDimensional, this))
                    {
                        item.TipoReporteDimensional = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
