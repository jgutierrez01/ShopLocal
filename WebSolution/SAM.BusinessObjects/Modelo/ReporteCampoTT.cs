...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class ReporteCampoTT: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ReporteCampoTTID
        {
            ...
            set
            {
                if (_reporteCampoTTID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ReporteCampoTTID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupProyecto(Proyecto previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReporteCampoTT.Contains(this))
            {
                previousValue.ReporteCampoTT.Remove(this);
            }
    
            if (Proyecto != null)
            {
                if (!Proyecto.ReporteCampoTT.Contains(this))
                {
                    Proyecto.ReporteCampoTT.Add(this);
                }
        ...
        private void FixupTipoPrueba(TipoPrueba previousValue)
        {
            ...
            if (TipoPrueba != null)
            {
                if (!TipoPrueba.ReporteCampoTT.Contains(this))
                {
                    TipoPrueba.ReporteCampoTT.Add(this);
                }
        ...
        private void FixupJuntaCampoReporteTT(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ReporteCampoTT, this))
                    {
                        item.ReporteCampoTT = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
