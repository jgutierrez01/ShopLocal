...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class CostoProcesoRaiz: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int CostoProcesoRaizID
        {
            get { return _costoProcesoRaizID; }
            set
            {
                if (_costoProcesoRaizID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'CostoProcesoRaizID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _costoProcesoRaizID = value;
                    OnPropertyChanged("CostoProcesoRaizID");
                }
            }
        }
        private int _costoProcesoRaizID;
        ...
        private void FixupDiametro(Diametro previousValue)
        {
            ...
            if (previousValue != null && previousValue.CostoProcesoRaiz.Contains(this))
            {
                previousValue.CostoProcesoRaiz.Remove(this);
            }
    
            if (Diametro != null)
            {
                if (!Diametro.CostoProcesoRaiz.Contains(this))
                {
                    Diametro.CostoProcesoRaiz.Add(this);
                }
        ...
        private void FixupFamiliaAcero(FamiliaAcero previousValue)
        {
            ...
            {
                if (!FamiliaAcero.CostoProcesoRaiz.Contains(this))
                {
                    FamiliaAcero.CostoProcesoRaiz.Add(this);
                }
        ...
        private void FixupProcesoRaiz(ProcesoRaiz previousValue)
        {
            ...
            if (ProcesoRaiz != null)
            {
                if (!ProcesoRaiz.CostoProcesoRaiz.Contains(this))
                {
                    ProcesoRaiz.CostoProcesoRaiz.Add(this);
                }
        ...
        private void FixupProyecto(Proyecto previousValue)
        {
            ...
            if (Proyecto != null)
            {
                if (!Proyecto.CostoProcesoRaiz.Contains(this))
                {
                    Proyecto.CostoProcesoRaiz.Add(this);
                }
        ...
        private void FixupTipoJunta(TipoJunta previousValue)
        {
            ...
            if (TipoJunta != null)
            {
                if (!TipoJunta.CostoProcesoRaiz.Contains(this))
                {
                    TipoJunta.CostoProcesoRaiz.Add(this);
                }
        ...
        private void FixupCedula(Cedula previousValue)
        {
            ...
            if (Cedula != null)
            {
                if (!Cedula.CostoProcesoRaiz.Contains(this))
                {
                    Cedula.CostoProcesoRaiz.Add(this);
                }
