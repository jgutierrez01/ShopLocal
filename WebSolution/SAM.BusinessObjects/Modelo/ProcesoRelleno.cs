...
namespace SAM.Entities
{
    ...
    [Serializable]
    public partial class ProcesoRelleno: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ProcesoRellenoID
        {
            ...
            set
            {
                if (_procesoRellenoID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ProcesoRellenoID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupWps(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ProcesoRelleno, this))
                    {
                        item.ProcesoRelleno = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
