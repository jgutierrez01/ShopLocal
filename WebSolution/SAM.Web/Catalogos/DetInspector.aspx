<%@ Page Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true" 
    CodeBehind="DetInspector.aspx.cs" Inherits="SAM.Web.Catalogos.DetInspector" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
    <sam:BarraTituloPagina runat="server" ID="titulo" NavigateUrl="~/Catalogos/LstInspector.aspx"
        meta:resourcekey="lblDetInspector" />
    ...
    <div class="dashboardCentral">
        <div class="divIzquierdo ancho70">            
            ...
            <div class="separador">
                <asp:Label ID="Label2" runat="server" CssClass="bold" meta:resourcekey="lblPatio" />
                <br />
            ...
            <div class="separador">
                <asp:Label ID="Label1" runat="server" CssClass="bold" meta:resourcekey="lblTaller" />
                <br />
