<%@ Page  Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true"
    CodeBehind="DetTransportista.aspx.cs" Inherits="SAM.Web.Catalogos.DetTransportista" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
    <sam:BarraTituloPagina runat="server" ID="titulo" NavigateUrl="~/Catalogos/LstTransportistas.aspx"
            ...
            <div>
                ...
                <div class="separador">
                    <mimo:LabeledTextBox runat="server" ID="txtTelefono" EntityPropertyName="Telefono"
                        MaxLength="15" meta:Resourcekey="lblTelefono" />
                </div>
            </div>
            <div>
                <br />
