<%@ Page Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true"
    CodeBehind="LstDespachador.aspx.cs" Inherits="SAM.Web.Catalogos.LstDespachador" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
     <telerik:RadAjaxManager runat="server" style="display:none;"  ID="ajaxMgr">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="grdDespachador">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdDespachador" LoadingPanelID="lpGrid" />
    ...
    <div class="contenedorCentral">
        ...
        <mimo:MimossRadGrid ID="grdDespachador" runat="server" OnNeedDataSource="grdDespachador_OnNeedDataSource"
            OnItemCommand="grdDespachador_ItemCommand" OnItemDataBound="grdDespachador_ItemDataBound">
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true">
                <CommandItemTemplate>
                    <div class="comandosEncabezado">
                        <div class="tituloGrid">
                            <asp:Label meta:resourcekey="lblLstDespachador" runat="server" ID="lblLstDespachador" />
                        </div>
                        <%if(PermisoDetalleDespachadores){ %>
                            <samweb:AuthenticatedHyperLink runat="server" ID="lnkAgregar" Text="Agregar" NavigateUrl="~/Catalogos/DetDespachador.aspx"
                            ...
                            <samweb:AuthenticatedHyperLink runat="server" ID="imgAgregar" ImageUrl="~/Imagenes/Iconos/agregar.png"
                                CssClass="imgEncabezado" NavigateUrl="~/Catalogos/DetDespachador.aspx" meta:resourcekey="imgAgregar" />
                        <%} %>
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                        Groupable="false">
                        <ItemTemplate>
                            <asp:LinkButton CommandName="Borrar" ID="lnkBorrar" runat="server" CommandArgument='<%#Eval("DespachadorID") %>'
                    ...
                    <telerik:GridBoundColumn UniqueName="DespachadorID" DataField="DespachadorID" Visible="false" />
