...
{
    public partial class DetInspector : SamPaginaCatalogo
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlPatios.Text != "" && ddlTaller.Text != "")
                {
                    GuardaEntidadPorId(WebConstants.CatalogoUrl.LST_INSPECTOR,
                                    InspectorBO.Instance.Obtener,
                                    InspectorBO.Instance.Guarda);
                }
            }
        ...
        /// <summary>
        /// metodo para cargar el combo "ddlTaller".
        /// </summary>
        private void CargarComboTaller()
        {
        ...
        private void Carga()
        {
            Inspector defecto = InspectorBO.Instance.Obtener(EntityID.Value);
            Map(defecto);
