...
{
    public partial class ImportaKgTeoricos : SamPaginaPrincipal
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if(IsValid)
            {
                try
                {
                    ...
                    KgTeoricoBL.Instance.ProcesaArchivoKgTeoricos(f.InputStream, SessionFacade.UserId);
                    Response.Redirect(WebConstants.CatalogoUrl.TBL_KG);
                }
