...
{
    public partial class DetDespachador : SamPaginaCatalogo
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                GuardaEntidadPorId(WebConstants.CatalogoUrl.LST_DESPACHADOR,
                                DespachadorBO.Instance.Obtener,
                                DespachadorBO.Instance.Guarda);
            }
        ...
        private void Carga()
        {
            Despachador defecto = DespachadorBO.Instance.Obtener(EntityID.Value);
            Map(defecto);
