<%@ Page  Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true"
    CodeBehind="DetDespachador.aspx.cs" Inherits="SAM.Web.Catalogos.DetDespachador" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
    <sam:BarraTituloPagina runat="server" ID="titulo" NavigateUrl="~/Catalogos/LstDespachador.aspx"
        meta:resourcekey="lblDetDespachador" />
