<%@ Page Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
    CodeBehind="LstArmado.aspx.cs" Inherits="SAM.Web.WorkStatus.LstArmado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    <telerik:RadAjaxManager runat="server" Style="display: none;" ID="ajxMgr">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="grdArmado">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdArmado" LoadingPanelID="loadingPanel" />
    ...
    <div class="contenedorCentral">
        <div class="cajaFiltros">
            <uc2:Filtro ProyectoRequerido="true" OrdenTrabajoRequerido="true" FiltroNumeroUnico="false"
                ProyectoHeaderID="headerProyecto" ProyectoAutoPostBack="true" NumeroControlAutoPostBack="true"
        ...
        <asp:PlaceHolder runat="server" ID="phArmado" Visible="False">
            <p>
            </p>
            <telerik:RadAjaxLoadingPanel runat="server" ID="loadingPanel" />
            <mimo:MimossRadGrid runat="server" ID="grdArmado" OnNeedDataSource="grdArmado_OnNeedDataSource"
                OnItemDataBound="grdArmado_OnItemDataBound" OnItemCommand="grdArmado_ItemCommand"
                ...
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" ClientDataKeyNames="OrdenTrabajoSpoolID"
                    ...
                    <Columns>
                        ...
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEditarArmado"
                                ImageUrl="~/Imagenes/Iconos/editar.png" meta:resourcekey="hlEditarArmado" runat="server" Visible="false"></asp:HyperLink>
                        </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" Groupable="false"
                            ShowFilterIcon="false" ShowSortIcon="false" Resizable="false" Reorderable="false"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlArmar" meta:resourcekey="hlArmar" Visible="false"
                                    ImageUrl="~/Imagenes/Iconos/ico_armarB.png" />
                                <asp:ImageButton runat="server" ID="hlCancelar" meta:resourcekey="hlCancelar" ImageUrl="~/Imagenes/Iconos/borrar.png"
                                    CommandName="cancelar" CommandArgument='<%#Eval("JuntaArmadoID") %>' OnClientClick="return Sam.Confirma(11);" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridBoundColumn meta:resourcekey="tipoCol" HeaderStyle-Width="60" FilterControlWidth="30"
                            DataField="TipoJunta" />
