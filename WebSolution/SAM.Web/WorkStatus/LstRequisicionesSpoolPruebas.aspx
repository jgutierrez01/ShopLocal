<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
         CodeBehind="LstRequisicionesSpoolPruebas.aspx.cs" Inherits="SAM.Web.WorkStatus.LstRequisicionesSpoolPruebas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="paginaHeader">
        <asp:Label runat="server" ID="lblRequisicionPruebas" CssClass="Titulo" meta:resourcekey="lblRequisicionPruebas" />
    </div>
    <div class="contenedorCentral">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdSpools" OnNeedDataSource="grdSpools_OnNeedDataSource"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="WorkstatusSpoolID,OrdenTrabajoSpoolID"
                ClientDataKeyNames="WorkstatusSpoolID,OrdenTrabajoSpoolID">
                <CommandItemTemplate>
