...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:PlaceHolder ID="phControles" runat="server">
        <div class="divIzquierdo ancho50">
            ...
            <div class="separador">
                <asp:Label runat="server" ID="lblFechaEmbarque" meta:resourcekey="lblFechaEmbarqueCarga"
                    CssClass="bold" />
                <br />
                <mimo:MappableDatePicker ID="mdpFechaEmbarqueCarga" runat="server" Style="width: 209px" AutoPostBack="true" />
                <span class="required">*</span>
                <asp:RequiredFieldValidator ID="valFecha" runat="server" ControlToValidate="mdpFechaEmbarqueCarga"
                    Display="None" meta:resourcekey="valFecha"></asp:RequiredFieldValidator>
            </div>
            <div class="separador">
                <asp:Label runat="server" ID="lblFechaVigenciaAduana" meta:resourcekey="lblFechaVigenciaAduana" CssClass="bold" />
                <br />
                <mimo:MappableDatePicker ID="mdpVigenciaAduana" runat="server" Style="width: 209px" />              
            </div>  
            <div class="separador">
        ...
        <table class="mensajeExito small" cellpadding="0" cellspacing="0" style="margin: 20px auto 0 auto;">
            ...
            <tr>
                <td class="cuerpo">
                    ...
                    <br/>
                    <br/>
                    <asp:Label runat ="server" ID="lblMensajeSinActualizacionLocalizacion" meta:resourcekey="lblMensajeSinActualizacionLocalizacion" visible="false"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
