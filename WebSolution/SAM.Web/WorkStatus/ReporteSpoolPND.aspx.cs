    ...
    public partial class ReporteSpoolPND : SamPaginaPrincipal
    {
        ...
        protected void grdReporteSpoolPND_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                HyperLink hlEditar = (HyperLink)item["editarRegistro"].FindControl("hlEditarSpoolPND");
                ...
                {
                    hlEditar.NavigateUrl = string.Format(JS_POPUP_EDICIONESPECIAL, repPnd.ReporteSpoolPndID, 3);
