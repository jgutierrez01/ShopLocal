...
namespace SAM.Web.WorkStatus
{
    public partial class LstReqPintura : SamPaginaPrincipal
    {
        ...
        {
            List<GrdRequisicionPintura> DataSource = RequisicionPinturaBO.Instance.ObtenerListadoRequisicionPintura(ProyectoID, OrdenTrabajoID, AccionID);        
            grdReqNum.DataSource = DataSource;

            litSpoolsTotales.Text = (from rp in DataSource
                                     select rp.SpoolID).Count().SafeStringParse();
