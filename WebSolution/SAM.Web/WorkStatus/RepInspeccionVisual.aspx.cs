    ...
    public partial class RepInspeccionVisual : SamPaginaPrincipal
    {
        ...
        protected void grdVisual_ItemDataBound(object source, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                HyperLink hlEdicionEspecial = e.Item.FindControl("hlEditarVisual") as HyperLink;
                ...
                {
                    hlEdicionEspecial.NavigateUrl = string.Format(JS_POPUP_EDICIONESPECIAL, reporte.InspeccionVisualID, 1);
                    hlEdicionEspecial.Visible = true;
                }
            }      
        }
