...
namespace SAM.Web.WorkStatus
{
    public partial class LstDespacho : SamPaginaPrincipal
    {
        ...
        private const string JS_POPUP_EDICION = "javascript:Sam.Workstatus.AbrePopupEdicionEspecialDespacho({0});";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string temp = btnQuitaSeleccionados.ClientID;
            }
        }     
        ...
        protected void grdDespachos_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if (e.Item.IsItem())
            {
                HyperLink link = e.Item.FindControl("hlEditarDespacho") as HyperLink;
                ...
                if (SessionFacade.PermisoEdicionesEspeciales && item.Estatus == "Activo")
                {
                    link.NavigateUrl = string.Format(JS_POPUP_EDICION, item.DespachoID);
                    link.Visible = true;
                }
            }
        }
