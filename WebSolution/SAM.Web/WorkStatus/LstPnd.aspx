<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true" CodeBehind="LstPnd.aspx.cs" Inherits="SAM.Web.WorkStatus.LstPnd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="contenedorCentral">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdJuntas" OnNeedDataSource="grdJuntas_OnNeedDataSource"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="JuntaWorkstatusID,RequisicionID"
                ClientDataKeyNames="JuntaWorkstatusID,RequisicionID">
                <CommandItemTemplate>
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="hdCedula" DataField="Cedula" meta:resourcekey="hdCedula"
                        FilterControlWidth="50" HeaderStyle-Width="100" />
                    <telerik:GridBoundColumn UniqueName="hdFamiliaAcero1" DataField="FamiliaAceroMaterial1" meta:resourcekey="hdFamiliaAcero1"
                        FilterControlWidth="50" HeaderStyle-Width="100" />
                    <telerik:GridBoundColumn UniqueName="hdFamiliaAcero2" DataField="FamiliaAceroMaterial2" meta:resourcekey="hdFamiliaAcero2"
                        FilterControlWidth="50" HeaderStyle-Width="100" />
                    <telerik:GridBoundColumn UniqueName="hdDiametro" DataField="Diametro" DataFormatString="{0:N3}" meta:resourcekey="hdDiametro"
