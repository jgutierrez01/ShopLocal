<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
    CodeBehind="RepInspeccionDimensional.aspx.cs" Inherits="SAM.Web.WorkStatus.RepInspeccionDimensional" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="contenedorCentral">
        ...
        <asp:PlaceHolder runat="server" ID="phGrid" Visible="false">
            ...
            <mimo:MimossRadGrid ID="grdDimensional" runat="server" OnNeedDataSource="grdDimensional_OnNeedDataSource"
                OnItemDataBound="grdDimensional_ItemDataBound" OnItemCommand="grdDimensional_ItemCommand">
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="btnDetalle_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlDetalle" ImageUrl="~/Imagenes/Iconos/info.png"
                                    NavigateUrl='<%#Eval("ReporteDimensionalID","~/WorkStatus/DetInspeccionDimensional.aspx?ID={0}") %>'
                        ...
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEditarDimencional"
                                ImageUrl="~/Imagenes/Iconos/editar.png" meta:resourcekey="hlEditarDimencional" runat="server" Visible="false"></asp:HyperLink>
                        </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:ImageButton CommandName="Borrar" Text="Borrar" ID="btnBorrar" runat="server"
                                    meta:resourcekey="imgBorrar" ImageUrl="~/Imagenes/Iconos/borrar.png" CommandArgument='<%#Eval("ReporteDimensionalID") %>'
                        ...
                        <telerik:GridBoundColumn UniqueName="Fecha" DataField="Fecha" HeaderStyle-Width="180"
                         ...
                         <telerik:GridBoundColumn UniqueName="TipoReporte" DataField="TipoReporte" HeaderStyle-Width="180"
                            FilterControlWidth="100" Groupable="false" meta:resourcekey="gbcTipoReporte" />
                        <telerik:GridBoundColumn UniqueName="SpoolsTotales" DataField="SpoolsTotales" HeaderStyle-Width="180"
                            FilterControlWidth="100" Groupable="false" meta:resourcekey="gbcSpoolsTotales" />
                        <telerik:GridBoundColumn UniqueName="SpoolsAprobados" DataField="SpoolsAprobados"
                            HeaderStyle-Width="180" FilterControlWidth="100" Groupable="false" meta:resourcekey="gbcSpoolsAprobados" />
                        <telerik:GridBoundColumn UniqueName="SpoolsRechazados" DataField="SpoolsRechazados"
                            HeaderStyle-Width="180" FilterControlWidth="100" Groupable="false" meta:resourcekey="gbcSpoolsRechazados" />
