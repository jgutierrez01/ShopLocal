<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Popup.Master" AutoEventWireup="true" CodeBehind="PopUpReporteTransferencia.aspx.cs" Inherits="SAM.Web.WorkStatus.PopUpReporteTransferencia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    <h4>
        <asp:Literal runat="server" ID="lblReportesTransferencia" meta:resourcekey="lblReportesTransferencia"></asp:Literal>
    </h4>
    <div class="cajaAzul">
                        ...
                        <tr class="repFila">   
                            <td>
                                <asp:ImageButton ID="lnkBorra" runat="server" ImageUrl="~/Imagenes/Iconos/borrar.png"
                                    CommandName="Borra" CommandArgument='<%#Eval("TipoAccionTransferenciaEnum")%>' OnClientClick="return Sam.Confirma(1);">
                                </asp:ImageButton>
                            </td>                        
                            <td>
                                <%#Eval("Accion")%>
