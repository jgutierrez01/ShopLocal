    ...
    public partial class RepInspeccionDimensional : SamPaginaPrincipal
    {
        ...
        protected void grdDimensional_ItemDataBound(object source, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                HyperLink hlEditar = e.Item.FindControl("hlEditarDimencional") as HyperLink;
                ...
                {
                    hlEditar.NavigateUrl = string.Format(JS_POPUP_EDICIONESPECIAL, reporte.ReporteDimensionalID, 2);
