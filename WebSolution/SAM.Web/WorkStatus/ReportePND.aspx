<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
    CodeBehind="ReportePND.aspx.cs" Inherits="SAM.Web.WorkStatus.ReportePND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
     <telerik:RadAjaxManager runat="server" style="display:none;"  ID="rdManager">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="grdReportePND">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdReportePND" LoadingPanelID="ldPanel" />
    ...
    <div class="paginaHeader">
        <asp:Label runat="server" ID="lblReportePND" CssClass="Titulo" meta:resourcekey="lblReportePND"
            Text="REPORTE - PND"></asp:Label>
    </div>
    <div class="contenedorCentral">
        ...
        <asp:PlaceHolder runat="server" ID="phGrid" Visible="false">
            ...
            <mimo:MimossRadGrid ID="grdReportePND" runat="server" OnNeedDataSource="grdReportePND_OnNeedDataSource"
                OnItemCommand="grdReportePND_ItemCommand" OnItemDataBound="grdReportePND_OnItemDataBound">
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="hlVer_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink runat="server" meta:resourcekey="hlVer" ID="hlVer" ImageUrl="~/Imagenes/Iconos/info.png"
                                    NavigateUrl='<%#Eval("ReportePndID","~/WorkStatus/DetReportePnd.aspx?ID={0}") %>' />
                            </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEditarPND"
                                ImageUrl="~/Imagenes/Iconos/editar.png" meta:resourcekey="hlEditarPND" runat="server" Visible="false"></asp:HyperLink>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:ImageButton CommandName="Borrar" Text="Borrar" ID="btnBorrar" runat="server"
                                    meta:resourcekey="btnBorrar" ImageUrl="~/Imagenes/Iconos/borrar.png" CommandArgument='<%#Eval("ReportePndID") %>'
