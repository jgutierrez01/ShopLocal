                ...
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" ClientDataKeyNames="OrdenTrabajoSpoolID"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" Groupable="false"
                         ...
                         <telerik:GridTemplateColumn UniqueName="editarRegistro" AllowFiltering="false" HeaderStyle-Width="30" Groupable="false"
                            ShowFilterIcon="false" ShowSortIcon="false" Resizable="false" Reorderable="false">
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEditarSoldadura" meta:resourcekey="hlEditarSoldadura"
                                ImageUrl="~/Imagenes/Iconos/editar.png"  runat="server" Visible="false"></asp:HyperLink>
                        </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" Groupable="false"
                            ShowFilterIcon="false" ShowSortIcon="false" Resizable="false" Reorderable="false"
                        ...
                        <telerik:GridCheckBoxColumn meta:resourcekey="RequierePWHT" HeaderStyle-Width="80" FilterControlWidth="50"
                             DataField="RequierePWHT">
                        </telerik:GridCheckBoxColumn>
