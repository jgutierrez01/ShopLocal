        ...
        <div class="divIzquierdo ancho70">
            <div class="divIzquierdo ancho50">
                ...
                <div class="separador">
                    ...
                    <br />
                    <mimo:MappableDropDown runat="server" ID="ddlTaller" EntityPropertyName="TallerID" AutoPostBack="true" OnSelectedIndexChanged="ddlTaller_SelectedIndexChanged" />
                    <span class="required">*</span>
                ...
                <div class="separador" style="margin-top: 15px">
                        ...
                        <telerik:RadComboBox ID="rcbInspector" runat="server" Width="200px" Height="150px" OnClientItemsRequesting="Sam.WebService.AgregaTallerID"
                            EnableLoadOnDemand="true" ShowMoreResultsBox="true" EnableVirtualScrolling="true" AutoPostBack="true"
                            CausesValidation="false" OnClientItemDataBound="Sam.WebService.InspectorTablaDataBound"
