<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true" 
         CodeBehind="RepRequisicionesSpool.aspx.cs" Inherits="SAM.Web.WorkStatus.RepRequisicionesSpool" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
     <telerik:RadAjaxManager runat="server" style="display:none;"  ID="rdManager">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="grdRequisicionesSpool">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdRequisicionesSpool" LoadingPanelID="ldPanel" />
    ...
    <div class="contenedorCentral">
        ...
        <asp:PlaceHolder runat="server" ID="phGrid" Visible="false">
            ...
            <mimo:MimossRadGrid ID="grdRequisicionesSpool" runat="server" OnNeedDataSource="grdRequisicionesSpool_OnNeedDataSource"
                OnItemDataBound="grdRequisicionesSpool_ItemDataBound" OnItemCommand="grdRequisicionesSpool_ItemCommand" AllowFilteringByColumn="true">
                <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="NumeroRequisicion" ClientDataKeyNames="NumeroRequisicion">
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="btnDetalle_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlDetalle" ImageUrl="~/Imagenes/Iconos/info.png"
                                    NavigateUrl='<%#Eval("RequisicionSpoolID","~/WorkStatus/DetRequisicionSpool.aspx?ID={0}") %>'
                        ...
                        <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                <asp:ImageButton CommandName="Borrar" ID="btnBorrar" runat="server" meta:resourcekey="imgBorrar"
                                    ImageUrl="~/Imagenes/Iconos/borrar.png" CommandArgument='<%#Eval("RequisicionSpoolID") %>'
                        ...
                        <telerik:GridBoundColumn UniqueName="SpoolsTotales" DataField="SpoolsTotales" HeaderStyle-Width="180" DataFormatString="{0:N0}"
