...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    <telerik:RadAjaxManager ID="radAjaxMng" runat="server" EnablePageHeadUpdate="true">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rcbCortadores">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rcbCortadores" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="radNumUnico">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="phDatos" />
                    <telerik:AjaxUpdatedControl ControlID="radNumUnico" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="radEtiquetaMaterial">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="pnMaquina" />
                    <telerik:AjaxUpdatedControl ControlID="radEtiquetaMaterial" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btnAgregar">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="txtSobrante" />
                    <telerik:AjaxUpdatedControl ControlID="rcbCortadores" />              
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="contenedorCentral">
        <div id="templateNumeroUnico" class="sys-template">
            <table class="rcbGenerico" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="codigo">{{CodigoSegmento}}
                    </td>
                    <td class="itemCode">{{ItemCode}}
                    </td>
                    <td class="diam1">{{Diametro1}}
                    </td>
                    <td class="diam2">{{Diametro2}}
                    </td>
                    <td>{{InventarioBuenEstado}}
                    </td>
                </tr>
            </table>
        </div>
        <div id="templateEtiquetaMaterial" class="sys-template">
            <table class="rcbGenerico" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="etiqueta">{{EtiquetaSeccion}}
                    </td>
                    <td class="etiqueta">{{EtiquetaMaterial}}
                    </td>
                    <td class="itemCode">{{ItemCode}}
                    </td>
                    <td class="descripcion">{{Descripcion}}
                    </td>
                    <td>{{EsEquivalente}}
                    </td>
                </tr>
        ...
        <div id="templateCortador" class="sys-template">
            <table class="rcbGenerico" cellpadding="0" cellspacing="0">
                <tr>
                ...
                <div class="separador">
                    <asp:Panel ID="pnlNumeroUnico" runat="server">
                        ...
                        <telerik:RadComboBox runat="server" ID="radNumUnico" Height="150px" Width="200px"
                            ...
                            OnClientItemDataBound="Sam.WebService.NumeroUnicoTablaDataBound" 
                            OnClientSelectedIndexChanged="Sam.WebService.RadComboOnSelectedIndexChanged"
                            OnSelectedIndexChanged="radNumUnico_SelectedIndexChanged"
                    ...
                    <div class="divDerecho ancho70">
                        <asp:PlaceHolder ID="phDatosNumUnico" runat="server" Visible="false">
                            <div class="divIzquierdo ancho50">
                                ...
                                <asp:Label ID="lblICNum" runat="server" meta:resourcekey="lblICNumResource1"></asp:Label>
                                </p>
                                <p>
                                    <asp:Label ID="lblDiam1NumTitulo" runat="server" CssClass="bold" meta:resourcekey="lblDiam1NumTitulo"></asp:Label>&nbsp;
                                <asp:Label ID="lblDiam1Num" runat="server" meta:resourcekey="lblDiam1NumResource1"></asp:Label>
                                </p>
                                <p>
                                    <asp:Label ID="lblInvFisicoTitulo" runat="server" CssClass="bold" meta:resourcekey="lblInvFisicoTitulo"></asp:Label>&nbsp;
                                <asp:Label ID="lblInvFisico" runat="server" meta:resourcekey="lblInvFisicoResource1"></asp:Label>
                                </p>
                            </div>
                            <div class="divDerecho ancho45">
                                ...
                                <asp:Label ID="lblDescripcionNum" runat="server" meta:resourcekey="lblDescripcionNumResource1"></asp:Label>
                                </p>
                                <p>
                                    <asp:Label ID="lblDiam2NumTitulo" runat="server" CssClass="bold" meta:resourcekey="lblDiam2NumTitulo"></asp:Label>&nbsp;
                                <asp:Label ID="lblDiam2Num" runat="server" meta:resourcekey="lblDiam2NumResource1"></asp:Label>
                                </p>
                                <p>
        ...
        <asp:PlaceHolder ID="plhCorte" runat="server" Visible="false">
            <div class="dashboardCentral">
                <asp:HiddenField ID="hdnTextCortador" runat="server" ClientIDMode="Static" />
                <asp:HiddenField ID="hdnCortadorSelected" runat="server" ClientIDMode="Static" />
                <div class="divIzquierdo ancho70">
                        ...
                        <div class="separador">
                            ...
                            <asp:Panel ID="pnNumeroControl" runat="server">
                                <telerik:RadComboBox ID="radNumeroControl" runat="server" Width="200px" Height="150px"
                                    ...
                                    CausesValidation="false" 
                                    CssClass="required" 
                                    OnSelectedIndexChanged="radNumeroControl_SelectedIndexChanged"
                                    OnClientItemsRequesting="Sam.WebService.NumControlOnClientItemsRequestingEventHandler">
                    ...
                    <div class="divDerecho ancho45">
                        ...
                        <div class="separador">
                            ...
                            <asp:Panel ID="pnEtiquetaMaterial" runat="server">
                                <telerik:RadComboBox ID="radEtiquetaMaterial" runat="server" Width="200px" Height="150px"
                                    OnClientItemsRequesting="Sam.WebService.MaterialesPorNumControlNumUnico" 
                                    EnableLoadOnDemand="true"
                                    ShowMoreResultsBox="true" 
                                    EnableVirtualScrolling="true" 
                                    CausesValidation="false"
                                    CssClass="required" 
                                    Enabled="false" 
                                    OnClientItemDataBound="Sam.WebService.EtiquetaMaterialTablaDataBound"
                                    OnClientSelectedIndexChanged="Sam.WebService.RadComboOnSelectedIndexChanged"
                        ...
                        <div class="separador">
                            <asp:Label runat="server" ID="lblCortador" meta:resourcekey="lblCortador" CssClass="bold" />&nbsp
                            <asp:Panel runat="server" ID="pnlCortador">
                                <telerik:RadComboBox ID="rcbCortadores" 
                                    ...
                                    AutoPostBack="true"
                                    CausesValidation="false" 
                                    OnClientItemDataBound="Sam.WebService.CortadorTablaDataBound"
                                    OnClientSelectedIndexChanged="Sam.WebService.RadCortadorSelectedIndexChanged"
                                    OnClientDropDownClosed="Sam.WebService.RadCortadorDropClosed" 
                                    DropDownCssClass="liGenerico" 
                                    DropDownWidth="400px">
                                    <WebServiceSettings Method="ListaCortadoresPorProyecto" Path="~/WebServices/ComboboxWebService.asmx" />
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" class="headerRcbGenerico">
                                            <tr>
                                                <th class="codigo">
                    ...
                    <div class="separador">
                        <asp:Button ID="btnAgregar" runat="server" meta:resourcekey="btnAgregar" OnClick="btnAgregar_OnClick"
                            CssClass="boton" ValidationGroup="vgAgregar" />
                    </div>
                    <div class="clear">
                            ...
                            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="false" ShowFooter="true">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridCheckBoxColumn UniqueName="EsAjuste" DataField="EsAjuste" HeaderStyle-Width="60" Reorderable="false"
                                     ...
                                     <telerik:GridBoundColumn UniqueName="MermaTeorica" DataField="MermaTeorica" Visible="false" />                     
                                </Columns>
                            </MasterTableView>
                    ...
                    <div class="separador">
                        <samweb:BotonProcesando ID="btnGuardar" runat="server" meta:resourcekey="btnGuardar" OnClick="btnGuardar_OnClick"
                            CssClass="boton" ValidationGroup="vgGuardar" />
                    </div>
                </div>
