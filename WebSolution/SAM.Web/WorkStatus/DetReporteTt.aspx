<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true" CodeBehind="DetReporteTt.aspx.cs" Inherits="SAM.Web.WorkStatus.DetReporteTt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
  <telerik:RadAjaxManager runat="server" style="display:none;"  ID="rdManager">
        ...
        NavigateUrl="~/WorkStatus/ReporteTT.aspx" /> 
        ...
        <div class="cajaAzul">
           <div class="divIzquierdo ancho80">
              <div class="divIzquierdo ancho30">
                 ...
                 <p></p>
                    <asp:Label ID="lblTipoPruebaLabel" runat="server" Text="Tipo de Prueba:" meta:resourcekey="lblTipoPruebaLabel"
                        CssClass="bold" />
         ...
         OnItemCreated="grdReportePnd_ItemCreated"
         OnItemCommand="grdReportePnd_OnItemCommand"
         OnItemDataBound="grdReporteTt_ItemDataBound"
         AllowMultiRowSelection="true">
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="JuntaReporteTtID"> 
             <CommandItemTemplate>
                ...
                <Columns>
                        <telerik:GridTemplateColumn UniqueName="btnBorrar_h" AllowFiltering="false" HeaderStyle-Width="30"
                            ...
                            <ItemTemplate>
                                ...
                                meta:resourcekey="btnBorrar" ImageUrl="~/Imagenes/Iconos/borrar.png" CommandArgument='<%#Eval("JuntaReporteTtID") %>'
                    ...
                    <telerik:GridBoundColumn UniqueName="HdGrafica" DataField="Grafica" HeaderText="Grafica"
                        HeaderStyle-Width="70" FilterControlWidth="30" Groupable="false"  meta:resourcekey="HdGrafica"/>  
