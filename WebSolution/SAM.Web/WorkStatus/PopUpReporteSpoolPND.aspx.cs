...
namespace SAM.Web.WorkStatus
{
    public partial class PopUpReporteSpoolPND : SamPaginaPopup
    {
        ...
        protected void ValidaFechas()
        {
            ...
            DateTime fechaReporte = rdpFechaReporte.SelectedDate.Value;
            DateTime fechaPrueba = rdpFechaPrueba.SelectedDate.Value;
            ...
            {
                if (fechaPrueba < DateTime.ParseExact(arregloFechas[i], "MM/dd/yyyy", CultureInfo.InvariantCulture))
                {
