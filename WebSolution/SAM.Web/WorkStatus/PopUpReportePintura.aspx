...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div class="cajaAzul">
        ...
        <div class="divIzquierdo ancho50">
            ...
            <div>
                <asp:Button runat="server" ID="btnBorrarSistema" meta:resourcekey="btnBorraSistema" OnClientClick="return Sam.Workstatus.ConfirmaBorrarSistema();" CssClass="boton"  OnClick="btnBorraSistema_OnClick" />
                <%--      <mimo:AutoDisableButton ID="btnABorraSistema" meta:resourcekey="btnBorraSistema" runat="server" CssClass="boton"  />--%>               
                <br />
                <br />
