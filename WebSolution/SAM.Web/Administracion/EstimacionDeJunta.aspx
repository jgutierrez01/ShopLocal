<%@ Page  Language="C#" MasterPageFile="~/Masters/Administracion.Master" AutoEventWireup="true" CodeBehind="EstimacionDeJunta.aspx.cs" Inherits="SAM.Web.Administracion.EstimacionDeJunta" %>
 ...
 <div class="paginaHeader">
     ...
     <div class="contenedorCentral">
        <div class="cajaFiltros">
          ...
          <div class="divIzquierdo">
             <div class="separador">
                <samweb:BotonProcesando ID="btnMostrar" runat="server" meta:resourcekey="btnMostrar" OnClick="btnMostrar_OnClick" CssClass="boton" />
             </div>
          </div>
          <p></p>
        </div>
       ...
       <asp:ValidationSummary ID="valSummary" runat="server" DisplayMode="BulletList" CssClass="summaryList" meta:resourcekey="valSummary" />
        <p></p>
         ...
         <asp:PlaceHolder runat="server" ID="phGrid" Visible="false">
             <mimo:MimossRadGrid ID="grdEstimacionJunta" 
                                 runat="server" 
                                 OnNeedDataSource="grdEstimacionJunta_OnNeedDataSource"
                                 OnColumnCreated="grdEstimacionJunta_OnColumnCreated"
                                 AutoGenerateColumns="true"
                                 AllowMultiRowSelection="true"
                                 AllowMultiColumnSorting="true"
                                 OnItemCreated="grdEstimacionJunta_ItemCreated"
                                 >
                <ClientSettings Selecting-AllowRowSelect="true" /> 
                <MasterTableView AutoGenerateColumns="true"
                                 AllowMultiColumnSorting="true"
                                 DataKeyNames="JuntaWorkstatusId"
                                 ClientDataKeyNames="JuntaWorkstatusId">   
                    <CommandItemTemplate>
                        <div class="comandosEncabezado">
                            <asp:HyperLink runat="server" ID="hlEstimado" Text="Estimar" meta:resourcekey="hlEstimado" />
