    ...
    <asp:PlaceHolder runat="server" ID="phMaquina">
        <div class="clear">
            <div class="divIzquierdo ancho70">
                ...
                <div class="separador">
                     <mimo:LabeledTextBox ID="txtMermaTeorica" runat="server" EntityPropertyName="MermaTeorica"
                            MaxLength="50" meta:resourcekey="lblMermaTeorica" />
                </div>
                <div class="separador">
                            ...
                            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="false">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="Nombre" DataField="Nombre" HeaderStyle-Width="120"
                                     ...
                                     <telerik:GridBoundColumn UniqueName="MermaTeorica" DataField="MermaTeorica" HeaderStyle-Width="120"
                                        Groupable="false" meta:resourcekey="gbcMermaTeorica" />
