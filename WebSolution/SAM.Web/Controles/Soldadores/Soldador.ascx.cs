...
namespace SAM.Web.Controles.Soldadores
{
    public partial class Soldador : System.Web.UI.UserControl
    {
        ...
        public void Map(object entity)
        {
            ...
            txtAreaTrabajo.Text = soldador.AreaTrabajo;
        ...
        public void Unmap(object entity)
        {
            ...
            soldador.AreaTrabajo = txtAreaTrabajo.Text;
        }
        ...
        {
            if (SessionFacade.PermisoEdicionesLimitadaSoldador && !SessionFacade.EsAdministradorSistema)
            {
                txtAreaTrabajo.Enabled = true;
