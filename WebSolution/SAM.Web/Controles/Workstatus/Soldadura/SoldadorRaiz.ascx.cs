...
namespace SAM.Web.Controles.Workstatus.Soldadura
{
    public partial class SoldadorRaiz : System.Web.UI.UserControl
    {
        ...
        public event EventHandler EnviarSoldadores;
        ...
        public string ProcesoRaizSelectedItem
        {
            get
            {
                return ddlProcesoRaiz.SelectedItem.Text;
            }
            set
            {
                ddlProcesoRaiz.SelectedItem.Text = value;
            }
        }
        ...
        /// <param name="js"></param>
        public void CargaInformacion(JuntaWorkstatus jwks, JuntaSoldadura js, bool readOnly, string wpsRaizSelected = "" ,  bool edicionEspecial = false)
        {
            ...
            if (edicionEspecial)
            {
                ...
                CargaWPS(jwks.JuntaSpoolID, js.ProcesoRaizID.SafeIntParse(), material1, material2, juntaSpool.Espesor);
                if (wpsRaizSelected != "")
                {
                    ddlWps.SelectedValue = wpsRaizSelected;
                }
            }
        ...
        protected void grdSoldadores_ItemCommand(object sender, CommandEventArgs e)
        {
            ...
            if (e.CommandName == "Borrar")
            {
                ...
                if (SoldarConRaiz)
                {
                    if (EnviarSoldadores != null)
                    {
                        EnviarSoldadores(sender, e);
                    }
                }
            }
        }
        ...
        public void CargaWPS(int juntaSpoolID, int procesoRaizID, string material1, string material2, decimal? espesorJunta)
        {
            if (procesoRaizID > 0)
            {
