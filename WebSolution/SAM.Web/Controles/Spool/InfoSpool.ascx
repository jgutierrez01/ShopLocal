        ...
        <div class="divIzquierdo ancho100">
            <div class="divIzquierdo ancho50">
                ...
                <p>
                 ...
                 <p>
                    <%--<asp:CheckBox ID="chkRequierePruebaHidrostatica" runat="server" />--%>
                    <asp:Label ID="lblRequierePruebaHidrostatica" runat="server" CssClass="bold" meta:resourcekey="lblrequierePruebaHidrostatica" />
                     <asp:DropDownList ID="ddRequierePruebaHidrostatica" runat="server">
                     </asp:DropDownList>
                </p>
            </div>
            <div class="divIzquierdo ancho50">
