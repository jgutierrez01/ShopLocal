    ...
    <table class="repSam" cellpadding="0" cellspacing="0">
        ...
        <thead>
            <tr class="repEncabezado">
                <th colspan="10"><asp:Literal runat="server" ID="litMateriales" meta:resourcekey="litMateriales" /></th>
            </tr>
            <tr class="repTitulos">
                <th><asp:Literal runat="server" ID="litObservaciones"></asp:Literal></th>
        ...
        <asp:Repeater runat="server" ID="repMateriales" OnItemDataBound="repMateriales_ItemDataBound" >
            <ItemTemplate>
                <tr class="repFila">
                    <td><asp:Image ID="imgObservaciones" runat="server" ImageUrl="~/Imagenes/Iconos/advertenciaGridB.png" Visible="false"/></td>
