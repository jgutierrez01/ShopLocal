...
{
    public partial class InfoSpoolRO : UserControl, IMappable
    {
        public void Map(object entity)
        {
            ...
            DetSpool spool = (DetSpool)entity;
        ...
        private static IEnumerable<Pair> obtenNomenclatura(List<NomenclaturaStruct> nomenclatura, DetSpool spool)
        {
