...
namespace SAM.Web.Controles.Spool
{
    public partial class Junta : System.Web.UI.UserControl, IMappable
    {
        ...
        private string Si = Thread.CurrentThread.CurrentUICulture.Name == LanguageHelper.INGLES ? "Yes" : "Si";       
        ...
        protected void MostrarEdicion(Entities.JuntaSpool junta, bool mostrarAdvertencia, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editar")
            {
                ...
                chkRequierePwht.Checked =  junta.RequierePwht;
                
                bool requierePruebNeumatica = false;
                Boolean.TryParse(junta.RequierePruebaNeumatica.SafeStringParse(), out requierePruebNeumatica);
                chkRequierePruebaNeumatica.Checked = requierePruebNeumatica;               
            }
        ...
        protected void grdJuntas_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            ...
            bool requierePwht = false;         
            bool requierePruebaNeumatica = false;
            ...
            if (e.Item is GridDataItem)
            {
                ...
                requierePwht = juntas.RequierePwht;
                Boolean.TryParse(juntas.RequierePruebaNeumatica.ToString(), out requierePruebaNeumatica);               
                ...
                dataItem["RequierePwht"].Text = requierePwht ? Si : "No";
                dataItem["RequierePruebaNeumatica"].Text = requierePruebaNeumatica ? Si : "No";
             }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                junta.RequierePwht = chkRequierePwht.Checked;
                junta.RequierePruebaNeumatica = chkRequierePruebaNeumatica.Checked;
        ...
        private void limpiarDatosDeCaptura()
        {
            ...
            chkRequierePwht.Checked = false;
            chkRequierePruebaNeumatica.Checked = false;
        }
        ...
        public void Unmap(object entity)
        {
            ...
            foreach (Entities.JuntaSpool junta in Juntas)
            {
                ...
                if (bd.RequierePwht != junta.RequierePwht)
                {
                    esEdicion = true;
                }
                if (bd.RequierePruebaNeumatica != junta.RequierePruebaNeumatica)
                {
                    esEdicion = true;
                }
                ...
                bd.RequierePwht = junta.RequierePwht;
                bd.RequierePruebaNeumatica = junta.RequierePruebaNeumatica;
