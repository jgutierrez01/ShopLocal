...
<div class="menuInferior" style="margin-top:0px; display:block;">
    ...
    <asp:Panel ID="pnCalidad" runat="server" CssClass="Elemento" Visible="false">
        <ul>
            ...
            <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlLiberacionCalidad" NavigateUrl="~/Calidad/LiberacionCalidad.aspx"
                     meta:resourcekey="hlLiberacionCalidad"></samweb:AuthenticatedHyperLink>
            </li>
            <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlOkPnd" NavigateUrl="~/Calidad/OkPND.aspx" meta:resourcekey="hypOkPnd"></samweb:AuthenticatedHyperLink>
            </li>
        </ul>
    </asp:Panel>
    <!----Catalogos ya quedo---->
    ...
    <asp:Panel ID="pnMateriales" runat="server" CssClass="Elemento" Visible="false">
        <ul>           
           ...
           <%-- <li>
            ...
            <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlLiberacionMateriales" NavigateUrl="~/Materiales/LiberacionMateriales.aspx"
                    meta:resourcekey="hlLiberacionMateriales"></samweb:AuthenticatedHyperLink>
            </li>
        </ul>
    </asp:Panel>
    <!----Producción ya quedo---->
    <asp:Panel ID="pnProduccion" runat="server" CssClass="Elemento" Visible="false">
        <ul>            
           ...
           <%-- <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlOrdenTrabajoEspecial" NavigateUrl="~/Produccion/ODTEspecial.aspx"
                    meta:resourcekey="hlOrdenTrabajoEspecial" />
            </li>--%>
        </ul>
    </asp:Panel>
    ...
    <asp:Panel ID="pnWorkstatus" runat="server" CssClass="Elemento" Visible="false">
        <ul>
            ...
            <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlRepEmbarque" NavigateUrl="~/WorkStatus/RepEmbarque.aspx" meta:resourcekey="hypRepEmbarque"></samweb:AuthenticatedHyperLink>
            </li>
             <li>
                <samweb:AuthenticatedHyperLink runat="server" ID="hlTransferenciaSpool" NavigateUrl="~/WorkStatus/LstTransferenciaSpool.aspx" meta:resourcekey="hlTransferenciaSpool"></samweb:AuthenticatedHyperLink>
            </li>
        </ul>
    </asp:Panel>
</div>
