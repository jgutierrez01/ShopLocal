...
namespace SAM.Web.Classes
{
    ...
    public static class UtileriasReportes
    {
        ...
        public static byte[] ObtenReporteOdtEspecial(int ordenTrabajoEspecialID, bool caratula, bool juntas, bool cortes, bool materiales, bool resumenMateriales)
        {
            List<PdfWrapper> listaFinal = new List<PdfWrapper>(8);
            MyReportServerCredentials c = new MyReportServerCredentials(Config.UsernameReportingServices, Config.PasswordReportingServices, Config.DomainReportingServices);
            ...
            if (caratula)
            {
                ReportViewer rptViewer = configuraReporteOdt(ordenTrabajoEspecialID, c, WebConstants.ReportesAplicacion.Odts_Caratula, 
                    TipoReporteProyectoEnum.CaratulaODTEspecial,true);
                listaFinal.Add(new PdfWrapper(rptViewer.ServerReport.Render("PDF"), OrientacionPagina.Horizontal));
            }
            if (juntas)
            {
                ReportViewer rptViewer = configuraReporteOdt(ordenTrabajoEspecialID, c, WebConstants.ReportesAplicacion.Odts_Juntas, 
                    TipoReporteProyectoEnum.JuntasODTEspecial,true);
                listaFinal.Add(new PdfWrapper(rptViewer.ServerReport.Render("PDF")));
            }
            if (materiales)
            {
                ReportViewer rptViewer = configuraReporteOdt(ordenTrabajoEspecialID, c, WebConstants.ReportesAplicacion.Odts_Materiales, 
                    TipoReporteProyectoEnum.MaterialesODTEspecial,true);
                listaFinal.Add(new PdfWrapper(rptViewer.ServerReport.Render("PDF")));
            }
            if (resumenMateriales)
            {
                ReportViewer rptViewer = configuraReporteOdt(ordenTrabajoEspecialID, c, WebConstants.ReportesAplicacion.Odts_ResumenMateriales, 
                    TipoReporteProyectoEnum.ResumenMeterialesODTEspecial,true);
                listaFinal.Add(new PdfWrapper(rptViewer.ServerReport.Render("PDF")));
            }
            if (cortes)
            {
                ReportViewer rptViewer = configuraReporteOdt(ordenTrabajoEspecialID, c, WebConstants.ReportesAplicacion.Odts_Cortes, 
                    TipoReporteProyectoEnum.CortesODTEspecial,true);
                listaFinal.Add(new PdfWrapper(rptViewer.ServerReport.Render("PDF")));
            }
        ...
        //private static ReportViewer configuraReporteOdtEspecial(int ordenTrabajoID, MyReportServerCredentials credenciales, string nombreReporte, TipoReporteProyectoEnum? tipoRep)
        //{
        ...
        /// <param name="nombreReporte"></param>
        /// <returns></returns>
        private static ReportViewer configuraReporteOdt(int ordenTrabajoID, MyReportServerCredentials credenciales, string nombreReporte, TipoReporteProyectoEnum? tipoRep, bool revisionesEspeciales = false)
        {
            string nombreReportePersonalizado = String.Empty;
            ...
            {
                int proyectoID = 0;
                if (revisionesEspeciales)
                {
                    //proyectoID = OrdenTrabajoBO.Instance.ObtenerODTEspecial(ordenTrabajoID).ProyectoID;
                }
                else
                {
                    proyectoID = OrdenTrabajoBO.Instance.Obtener(ordenTrabajoID).ProyectoID;
                }
        ...
        public static string DameRutaReporte(int proyectoID, TipoReporteProyectoEnum tipoRep)
        {
            ...
            switch (tipoRep)
            {
                ...
                case TipoReporteProyectoEnum.Hidrostatica:
                    ...
                    break;
                case TipoReporteProyectoEnum.Transferencia:
                    reporteDefault = WebConstants.ReportesAplicacion.Wkst_Transferencia;
                    break;
            }
