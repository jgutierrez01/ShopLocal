...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="contenedorCentral">               
        ...
        <mimo:MimossRadGrid ID="grdSegSpool" runat="server" OnNeedDataSource="grdSegSpool_OnNeedDataSource" OnItemCreated="grdSegSpool_ItemCreated"
            OnItemCommand="grdSegSpool_ItemCommand" OnItemDataBound="grdSegSpool_ItemDataBound" CssClass="RadGrid RadGrid_SAMOrange segJunta" ClientSettings-Scrolling-AllowScroll="true">
            <ClientSettings>
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="false" AllowFilteringByColumn="false">                    
                ...
                <Columns>        
                    ...
                    <telerik:GridTemplateColumn UniqueName="Agrupadores" AllowFiltering="false" Visible="false" Groupable="false" HeaderStyle-CssClass="rgHeader segJuntaHeader">
                        <HeaderTemplate>
                            <asp:Repeater ID="repHeaderAgrupadores" runat="server" OnItemDataBound="repHeader_ItemDataBound">
                                <HeaderTemplate>
                                    <table>
                                        <tr>
                                            <asp:Literal ID="litHeaderTitulo" runat="server" />
                        ...
                        <ItemTemplate>
                            <asp:Repeater ID="repCampoAgrupadores" runat="server" OnItemDataBound="repCampo_ItemDataBound">
                                <HeaderTemplate>
                                    <table>
                                </HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="AgrupadoresSpoolPnd" AllowFiltering="false" Visible="false" Groupable="false" HeaderStyle-CssClass="rgHeader segJuntaHeader">
                        <HeaderTemplate>
                            <asp:Repeater ID="repHeaderAgrupadoresSpoolPND" runat="server" OnItemDataBound="repHeader_ItemDataBound">
                                <HeaderTemplate>
                                    <table>
                                        <tr>
                                            <asp:Literal ID="litHeaderTitulo" runat="server" />
                        ...
                        <ItemTemplate>
                            <asp:Repeater ID="repCampoAgrupadoresSpoolPND" runat="server" OnItemDataBound="repCampo_ItemDataBound">
                                <HeaderTemplate>
                                    <table>
                                </HeaderTemplate>
