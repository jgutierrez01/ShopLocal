...
namespace SAM.Web.Proyectos
{
    public partial class DossierCalidad : SamPaginaPrincipal
    {
        ...
        public void cargaInformacion(int proyectoID)
        {
            ...
            chkDossier.Items[19].Selected = proyecto.ProyectoDossier.ReportePruebaHidrostatica != null ? proyecto.ProyectoDossier.ReportePruebaHidrostatica.Value : false;
...
//<<<<<<< HEAD
//            rdbLD.Items[0].Selected = proyecto.ProyectoDossier.LDCertificado;
//            rdbLD.Items[1].Selected = !proyecto.ProyectoDossier.LDCertificado;
//=======
            rdbLD.Items[0].Selected = proyecto.ProyectoDossier.LDCertificado.SafeBoolParse();
            rdbLD.Items[1].Selected = !proyecto.ProyectoDossier.LDCertificado.SafeBoolParse();
//>>>>>>> origin/Issue332
        }
        ...
        private void unbindCheckBoxList(Proyecto proyecto)
        {
            ...
            dossier.ReportePruebaHidrostatica = chkDossier.Items[19].Selected;
