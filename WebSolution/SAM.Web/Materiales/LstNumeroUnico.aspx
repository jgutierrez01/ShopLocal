        ...
        <mimo:MimossRadGrid runat="server" ID="grdNumeroUnicos" OnNeedDataSource="grdNumeroUnicos_OnNeedDataSource"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="hdInventarioCongelado" DataField="InventarioCongelado" DataFormatString="{0:N3}"
                         meta:resourcekey="hdInventarioCongelado" FilterControlWidth="50" HeaderStyle-Width="100"></telerik:GridBoundColumn>
