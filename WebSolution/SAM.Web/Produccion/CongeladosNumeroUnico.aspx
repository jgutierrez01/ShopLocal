    ...
    <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="grdSpools">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="lnkTranferenciaMasiva" LoadingPanelID="ldPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    </AjaxSettings>
        ...
        <div class="divIzquierdo">
            <div class="separador">
                <asp:Label runat="server" ID="lblProyecto" meta:resourcekey="lblProyecto" AssociatedControlID="ddlProyecto" />
                    <mimo:MappableDropDown runat="server" ID="ddlProyecto" meta:resourcekey="ddlProyecto" OnSelectedIndexChanged="ddlProyecto_SelectedIndexChange" 
                        AutoPostBack="true" />
        ...
        <div class="divIzquierdo">
            <div class="separador">
                <samweb:BotonProcesando meta:resourcekey="btnMostrar" ID="btnMostrar" runat="server" OnClick="btnMostrar_Click" CssClass="boton" />
                   &nbsp
                <samweb:BotonProcesando ID="btnTranferenciaMasiva" runat="server" OnClick="btnTranferenciaMasiva_Click" 
                    CssClass="boton" Text="Transferencia masiva" Visible="false" />
            </div>
        </div>
        <p></p>
    </div>
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" HierarchyLoadMode="ServerOnDemand" ClientDataKeyNames="SpoolID,CantCong,MaterialSpoolID" DataKeyNames="SpoolID,CantCong,MaterialSpoolID">
                <CommandItemTemplate>
                    <div class="comandosEncabezado">
                        ...
                        <asp:HyperLink meta:resourcekey="imgTransfCongelado" runat="server" ID="imgTransfCongelado" 
                            ImageUrl="~/Imagenes/Iconos/icono_odt.png" CssClass="imgEncabezado" />
                    </div>
                </CommandItemTemplate>
                <Columns>
