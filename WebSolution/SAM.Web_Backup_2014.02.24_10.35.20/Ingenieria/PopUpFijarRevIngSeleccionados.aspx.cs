...
{
    public partial class PopUpFijarRevIngSeleccionados : SamPaginaPopup
    {
        private int[] _spools
        {
            get
        ...
        protected void btnDocumentoAprobado_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SpoolBO.Instance.FijaDocumentacionAprobada(_spools,
                                                _proyectoID,
                                                SessionFacade.UserId,
                                                DateTime.Now,
                                                chkDocumentoAprobado.Checked);
