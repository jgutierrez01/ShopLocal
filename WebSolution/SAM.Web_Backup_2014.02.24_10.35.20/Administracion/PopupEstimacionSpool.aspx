<%@ Page  Language="C#" MasterPageFile="~/Masters/Popup.Master" AutoEventWireup="true"
    CodeBehind="PopupEstimacionSpool.aspx.cs" Inherits="SAM.Web.Administracion.PopupEstimacionSpool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <asp:PlaceHolder runat="server" ID="phControles">
            <h4>
                <asp:Literal runat="server" ID="litTitulo" meta:resourcekey="litTitulo" Text="Estimacion Spool" />
            </h4>
                ...
                <div class="divIzquierdo ancho50">
                    ...
                    <asp:Panel ID="pnNuevo" runat="server">
                        <div class="separador">
                            ...
                            <asp:TextBox ID="txtNumerioEstimacionNueva" runat="server" MaxLength="10" CssClass="required"></asp:TextBox>
                            <span class="required">*</span>
