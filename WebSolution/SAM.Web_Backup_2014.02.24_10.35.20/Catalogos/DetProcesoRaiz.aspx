<%@ Page  Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true"
    CodeBehind="DetProcesoRaiz.aspx.cs" Inherits="SAM.Web.Catalogos.DetProcesoRaiz" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyInner" runat="server">
    <sam:BarraTituloPagina runat="server" ID="titulo" NavigateUrl="~/Catalogos/LstProcesoRaiz.aspx"
        meta:resourcekey="lblDetProcesoRaiz" />
    ...
    <div class="dashboardCentral">
        ...
        <div class="divDerecho ancho30">
            <div class="validacionesRecuadro" style="margin-top: 15px;">
    ...
    <div class="pestanaBoton">
        <asp:Button runat="server" ID="btnGuardar" Text="Guardar" OnClick="btnGuardar_Click"
            CausesValidation="true" meta:resourcekey="btnGuardar" CssClass="boton" />
    </div>
</asp:Content>
