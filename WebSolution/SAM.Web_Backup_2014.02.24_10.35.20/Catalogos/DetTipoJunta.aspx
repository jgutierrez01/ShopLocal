<%@ Page  Language="C#" MasterPageFile="~/Masters/Catalogos.master" AutoEventWireup="true" CodeBehind="DetTipoJunta.aspx.cs" Inherits="SAM.Web.Catalogos.DetTipoJunta" %>
...
<sam:BarraTituloPagina runat="server" ID="titulo" meta:resourcekey="lblDetTipoJunta" NavigateUrl="~/Catalogos/LstTipoJunta.aspx" />

    <div class="cntCentralForma">
        <div class="dashboardCentral">
            <div class="divIzquierdo ancho70">
                <div class="separador">
                    <mimo:RequiredLabeledTextBox runat="server" ID="txtCodigo" EntityPropertyName="Codigo" ErrorMessage="El código es requerido" Label="Código:" meta:resourcekey="txtCodigo"/>
                </div>
                <div class="separador">
