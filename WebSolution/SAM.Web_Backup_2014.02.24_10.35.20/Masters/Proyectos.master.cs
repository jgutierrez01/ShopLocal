...
namespace SAM.Web.Masters
{
    public partial class Proyectos : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Master.EstableceMenuActivo(MenuItemEnum.Proyecto);
            }
        }
        ...
        /// </summary>
        /// <param name="item">pagina activa</param>
        public void EstablecerSubMenuActivo(SubMenuItemEnum item, int proyectoID)
        {
            Master.EstablecerSubMenuActivo(item, proyectoID);
        }
