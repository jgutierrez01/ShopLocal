...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="contenedorCentral">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdSpools" OnNeedDataSource="grdSpools_OnNeedDataSource" OnItemCreated="grdSpools_ItemCreated"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="WorkstatusSpoolID,RequisicionPinturaDetalleID"
                ClientDataKeyNames="WorkstatusSpoolID,RequisicionPinturaDetalleID">
                <CommandItemTemplate> 
