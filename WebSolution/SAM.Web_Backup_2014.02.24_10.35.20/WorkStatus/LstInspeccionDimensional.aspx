<%@ Page  Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
    CodeBehind="LstInspeccionDimensional.aspx.cs" Inherits="SAM.Web.WorkStatus.LstInspeccionDimensional" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="paginaHeader">
        <asp:Label runat="server" ID="lblInspeccionDimensional" CssClass="Titulo" meta:resourcekey="lblInspeccionDimensional"></asp:Label>
    </div>
    <div class="contenedorCentral">
        <div class="cajaFiltros">
            <uc2:Filtro ProyectoRequerido="true" OrdenTrabajoRequerido="true" FiltroNumeroUnico="false"
                FiltroNumeroControl="false" ProyectoHeaderID="proyEncabezado" ProyectoAutoPostBack="true" runat="server" ID="filtroGenerico"></uc2:Filtro>
            <div class="divIzquierdo">
                <div class="separador">
                    <asp:Label ID="lblTipoReporte" runat="server" CssClass="bold" meta:resourcekey="lblTipoReporte"></asp:Label><br />
                    <asp:DropDownList ID="ddlTipoReporte" runat="server" 
                        meta:resourcekey="ddlTipoReporteResource1">
                    </asp:DropDownList>
                    <span class="required">*</span>
                    <asp:RequiredFieldValidator ID="valTipoReporte" runat="server" 
                        ControlToValidate="ddlTipoReporte" Display="None" 
                        meta:resourcekey="valTipoReporte"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="divIzquierdo">
                <div class="separador">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdSpools" OnNeedDataSource="grdSpools_OnNeedDataSource"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="SpoolID"
                ...
                <Columns>
                    ...
                    <telerik:GridCheckBoxColumn UniqueName="hdSoldadura" DataField="Soldadura" meta:resourcekey="hdSoldadura"
                        FilterControlWidth="40" HeaderStyle-Width="80" />
                        <telerik:GridCheckBoxColumn UniqueName="hdInspeccionVisual" DataField="InspeccionVisual" meta:resourcekey="hdInspeccionVisual"
