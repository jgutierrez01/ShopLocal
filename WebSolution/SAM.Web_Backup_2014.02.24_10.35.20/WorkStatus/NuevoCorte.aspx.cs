    ...
    public partial class NuevoCorte : SamPaginaPrincipal
    {
        ...
        protected void btnGuardar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                CorteBL.Instance.GeneraNuevoCorte(CorteDetalleLista, txtSobrante.Text.SafeIntParse(), rack, radNumUnico.SelectedValue.SafeIntParse(), segmento, total, NumeroControl, SessionFacade.UserId);
