<%@ Page Language="C#" MasterPageFile="~/Masters/WorkStatus.master" AutoEventWireup="true"
    CodeBehind="LstTT.aspx.cs" Inherits="SAM.Web.WorkStatus.LstTT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyInner" runat="server">
    ...
    <div class="paginaHeader">
        <asp:Label runat="server" ID="lblTT" CssClass="Titulo" meta:resourcekey="lblTT"></asp:Label>
    </div>
    <div class="contenedorCentral">
        <div class="cajaFiltros">
            ...
            <div class="divIzquierdo" style="top: 0px;">
                <div class="separador">
            ...
            <div class="divIzquierdo" style="display: block;">
                <div class="separador">
        ...
        <mimo:MimossRadGrid runat="server" ID="grdJuntas" OnNeedDataSource="grdJuntas_OnNeedDataSource"
            ...
            <MasterTableView AutoGenerateColumns="false" AllowMultiColumnSorting="true" DataKeyNames="JuntaWorkstatusID,RequisicionID"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="hdRequisicion" DataField="NumeroRequisicion"
                        meta:resourcekey="hdRequisicion" FilterControlWidth="50" HeaderStyle-Width="100" />
